...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.upcomingView = [[UIView alloc] initWithFrame:CGRectMake(origin.x, origin.y, length, length)];
        
        self.upcomingView.layer.cornerRadius = length / 2;
        self.upcomingView.layer.borderColor = [UIColor blueColor].CGColor;
        self.upcomingView.layer.borderWidth =2;
        ...
        [self.viewForBaselineLayout addSubview:self.upcomingView];
